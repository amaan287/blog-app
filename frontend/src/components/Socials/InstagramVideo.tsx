...
export default function InstagramVideo() {
  ...
  return (
    <div className="flex flex-col-reverse items-center lg:items-start lg:flex-row md:gap-6 gap-4 justify-between min-h-screen bg-card p-4">
      ...
      <div className="flex flex-col items-center justify-center w-full md:w-1/2 px-4 pt-24">
